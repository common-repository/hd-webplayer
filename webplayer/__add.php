...
if($_POST['edited'] == 'true') {
	unset($_POST['group'], $_POST['edited'], $_POST['save']);
...
<div class="wrap">
  ...
  <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>" onsubmit="return webplayer_validate();" >
    ...
    <table cellpadding="0" cellspacing="15">
      ...
      <tr id="_playlistid">
      	<td><?php _e("Playlist ID" ); ?></td>
        <td><input type="text" id="playlistid" name="playlistid" value="<?php echo $data->playlistid; ?>" size="50"></td>
      </tr>
